...
<head>
  ...
  <title>{{ trans('laravel-filemanager::lfm.title-page').' - '.env('PROJECT_NAME') }}</title>
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/folder.png') }}">
  <link rel="stylesheet" type="text/css" href="{!! asset('css/app.css')!!}">
  <link rel="stylesheet" type="text/css" href="{!! asset('css/global.css')!!}">
  <link rel="stylesheet" type="text/css" href="{!! asset('css/implement.css')!!}">
  <link rel="stylesheet" type="text/css" href="{!! asset('css/cybertron.css')!!}">
...
<body>
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        <h1 class="panel-title">{{ trans('laravel-filemanager::lfm.title-panel').' - '.env('PROJECT_NAME') }}</h1>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10 col-xs-12" id="main">
        <nav class="navbar navbar-default" id="nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand visible-xs" href="javascript:void(0)">{{ trans('laravel-filemanager::lfm.title-panel') }}</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="javascript:void(0)" id="list-sort-alphabetic">
                      <i class="fa fa-sort-alpha-asc"></i> {{ trans('laravel-filemanager::lfm.nav-sort-alphabetic') }}
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" id="list-sort-time">
      ...
      <ul id="fab">
        <li>
          ...
          <ul class="hide">
            <li>
              <a href="javascript:void(0)" id="add-folder" data-mfb-label="{{ trans('laravel-filemanager::lfm.nav-new') }}">
                <i class="fa fa-folder"></i>
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" id="upload" data-mfb-label="{{ trans('laravel-filemanager::lfm.nav-upload') }}">
  ...
  <script>
    ...
    Dropzone.options.uploadForm = {
      ...
      dictDefaultMessage: 'O bien, suelte los archivos aquí para cargarlos.',
      init: function() {
        var _this = this // For the closure
        this.on("addedfile", function(file) { refreshFoldersAndItems('OK') })
        this.on('success', function(file, response) {
          if(response != 'OK') this.defaultOptions.error(file, response.join('\n'))
          if(response === 'OK') { $('#uploadModal').modal('toggle'); this.removeAllFiles(true) }
        })
