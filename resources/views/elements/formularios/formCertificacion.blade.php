            ...
            <fieldset>
                ...
                <div class="col-md-6">
                    <section>
                        ...
                        <label class="input">
                            ...
                            <autocomplete :suggestions="completeCertification" v-model="form.nameCertification"></autocomplete>
                        </label>
                ...
                <div class="col-md-12">
                    <div class="alert alert-sea">
                        <span class="glyphicon glyphicon-info-sign"></span> <strong>Solo ingresa una palabra en el nombre del instituto y el certificado, asi se mostrara un listado </strong>
                    </div>
                </div>
            </fieldset>
